...
- 각 bullet은 한 문장(한국어 약 25~55자)으로 간결하게 쓴다. 한 bullet에 여러 메시지를 욱여넣지 말고, 군더더기·중복은 제거한다.
...
예: "content": ["월풀 CEO가 소비지출을 <b>2008년 위기 수준</b>으로 경고", "북미 가전 수요가 구조적 저점 진입"]`;
...
- 내용·당사 기회·당사 위협·보고서 방향은 각각 1~3개의 짧은 bullet로 쓴다(한 bullet = 한 문장, 군더더기·중복 금지).
